              ...
              <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
                  <div className="hidden xl:inline max-w-[270px]">
                    ...
                    <div className="flex gap-x-2 gap-y-2.5 flex-wrap mb-3">
                      <div className="genres">Classic</div>
                      <div className="genres">House</div>
                      <div className="genres">Minimal</div>
                      <div className="genres">Hip-hop</div>
                      <div className="genres">Electronic</div>
                      <div className="genres">Chillout</div>
                      <div className="genres">Blues</div>
                      <div className="genres">Country</div>
                      <div className="genres">Techno</div>
                    </div>
                    <button className="text-[#CECECE] bg-[#1A1A1A] text-[13px] py-3.5 px-4 rounded-2xl w-full font-bold bg-opacity-100 transition ease-out">
                        All Genres
                    </button>
                  </div>
                  ...
                  <div className="w-full pr-11">
                    <h2 className="text-white font-bold mb-3">{searchResults.length === 0 ? "New Release" : "Tracks"}</h2>
